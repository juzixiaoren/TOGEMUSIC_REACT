...
const CL = {
    ...
    dialog: 'flex flex-col gap-3 bg-surface w-[min(980px,92vw)] h-[min(86vh,760px)] rounded-2xl p-[18px] shadow-dialog',
    ...
    pickListNested: 'border-none bg-surface-blue-light',
    ...
    sourceBtn: 'bg-surface-elevated rounded-md cursor-pointer border border-border-blue-expand py-[5px] px-2 text-text-blue-muted',
